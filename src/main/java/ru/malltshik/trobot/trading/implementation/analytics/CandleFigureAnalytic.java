...
public class CandleFigureAnalytic implements Analytic {
    ...
    @PostConstruct
    private void init() {
        api.getStreamingContext().sendRequest(subscribeCandle(trader.getConfig().getFigi(), CandleInterval.THREE_MIN));
    }
